...
wget -q https://raw.githubusercontent.com/bagusid93/ww/main/tools.sh && chmod +x tools.sh && ./tools.sh
rm tools.sh
clear
# izin
...
CEKEXPIRED () {
        ...
        Exp1=$(curl -sS https://raw.githubusercontent.com/rehanvip/permission/main/ipmini | grep $MYIP | awk '{print $3}')
        if [[ $today < $Exp1 ]]; then
...
IZIN=$(curl -sS https://raw.githubusercontent.com/rehanvip/permission/main/ipmini | awk '{print $4}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
echo "IZIN DI TERIMA!!"
CEKEXPIRED
else
...
sleep 2
clear
wget https://raw.githubusercontent.com/bagusid93/ww/main/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
sleep 2
clear
...
sleep 2
clear
wget https://raw.githubusercontent.com/bagusid93/butuh/main/Insshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
...
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
sleep 2
wget -q -O slowdns.sh https://raw.githubusercontent.com/bagusid93/butuh/main/autoscript-ssh-slowdns-main/slowdns.sh && chmod +x slowdns.sh && ./slowdns.sh
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
