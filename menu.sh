...
Name=$(curl -sS https://raw.githubusercontent.com/rehanvip/xray-ws/main/izin | grep $MYIP | awk '{print $2}')
Exp=$(curl -sS https://raw.githubusercontent.com/rehanvip/xray-ws/main/izin | grep $MYIP | awk '{print $3}')
